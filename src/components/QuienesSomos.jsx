            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-[var(--gris-claro)] max-w-3xl mx-auto">
                        Somos una empresa líder en la automatización y producción audiovisual, comprometida con la innovación y la excelencia para impulsar el crecimiento de tus proyectos.
                    </p>
                </div>
            </div>
        </Section>
